function FindProxyForURL(url, host) {
        ...
        if (dnsDomainIs(host, "sohu.com") || dnsDomainIs(host, "a.cn") || dnsDomainIs(host, "sina.com")) {
                return blackhole;
        } else if (dnsDomainIs(host, "twitter.com") || dnsDomainIs(host, ".twitter.com") || shExpMatch(url, "twitter.com")) {
                return proxy_yes;
        } else if (dnsDomainIs(host, "twttr.com") || dnsDomainIs(host, ".twttr.com") || shExpMatch(url, "twttr.com")) {
                return proxy_yes;
                ...
                return proxy_yes;
        } else if (dnsDomainIs(host, ".wikimedia.org") || shExpMatch(host, "wikimedia.org")) {
                return proxy_yes;
        } else if (dnsDomainIs(host, ".ow.ly") || shExpMatch(host, "ow.ly")) {
                return proxy_yes;
                ...
                return proxy_yes;
        } else if (dnsDomainIs(host, "github.com") || shExpMatch(host, "github.com")) {
                return proxy_yes;
        } else if (dnsDomainIs(host, "gist.github.com") || shExpMatch(host, "gist.github.com")) {
                return proxy_yes;
        } else if (dnsDomainIs(host, ".readthedocs.org") || shExpMatch(host, "readthedocs.org")) {
                return proxy_yes;
        } else if (dnsDomainIs(host, ".nytimes.com") || shExpMatch(host, "nytimes.com") || shExpMatch(host, "cn.nytimes.com")) {
                return proxy_yes;
                ...
                return proxy_yes;
        } else if (shExpMatch(host, "zinio.com")) {
                return proxy_yes;
        } else if (shExpMatch(host, "edgecastcdn.net")) {
                return proxy_yes;
        } else if (shExpMatch(host, "j.mp")) {
                return proxy_yes;
        } else if (shExpMatch(host, "dropbox")) {
                return proxy_yes;
        } else if (shExpMatch(host, "www.sitelutions.com")) {
                return proxy_yes;
        } else if (shExpMatch(host, "openvpn.net")) {
                return proxy_yes;
        } else if (shExpMatch(host, "alestic.com")) {
                return proxy_yes;
        } else if (shExpMatch(host, "archive.org")) {
                return proxy_yes;
        } else if (shExpMatch(host, "dw.de")) {
                return proxy_yes;
        } else if (shExpMatch(host, "asahichinese.com")) {
                return proxy_yes;
        } else if (shExpMatch(host, "space.wenxuecity.com")) {
                return proxy_yes;
        } else if (shExpMatch(host, "community.opscode.com")) {
                return proxy_yes;
        } else if (shExpMatch(host, "daw.apple.com")) {
                return proxy_yes;
        } else if (dnsDomainIs(host, "thepiratebay.se")) {
                return proxy_yes;
        } else if (dnsDomainIs(host, "pastebin.com")) {
                return proxy_yes;
        }
        return proxy_no;
}
